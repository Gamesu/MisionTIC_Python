...
def crear_lista_compuestos(lista_nombres, lista_formulas, lista_tipoCompuestos, lista_cantidades):
    lista_compuestos = []
...
lista_compuestos = crear_lista_compuestos(lista_nombres, lista_formulas, lista_tipoCompuestos, lista_cantidades)
...
tabla_compuestos = cc.clasificar_compuesto(mostrar_menu(), lista_tipoCompuestos, lista_compuestos, lista_cantidades)
